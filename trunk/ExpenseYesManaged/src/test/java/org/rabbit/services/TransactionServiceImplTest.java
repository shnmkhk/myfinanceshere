...
public class TransactionServiceImplTest extends BaseTest {
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#addNewTransaction(java.lang.String, double, double, org.rabbit.model.Entry)}
	 * .
	 * 
	...
	public final void testAddNewTransaction() throws SheetAlreadyExistsException, EntryAlreadyExistsException {
		...
		Entry entry = entryService.addANewEntry('I', 33000, "APRIL_MONTH_SALARY", "April Month Salary", 'S', sheet);
		Transaction transaction = transactionService.addNewTransaction("Description One", 20000, 1500, entry);

	}

	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#deleteTransaction(org.rabbit.model.Entry, int)}
	 * .
	 */
	@Test
	@Ignore
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#getAllTransactions()}
	 * .
	 */
	@Test
	@Ignore
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#getTransactionByEntry(org.rabbit.model.Entry)}
	 * .
	 */
	@Test
	@Ignore
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#getTransactionByEntryAndIndex(org.rabbit.model.Entry, int)}
	 * .
	 */
	@Test
	@Ignore
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.TransactionServiceImpl#updateTransaction(org.rabbit.model.Transaction)}
	 * .
	 */
	@Test
	@Ignore
