...
public class EntryDAOImplUTest extends BaseTest {
	...
	@Test
	public void testCreateNewEntry() throws EntryAlreadyExistsException, SheetAlreadyExistsException, EntryNotFoundException {
		...
		Entry entryEval = entryDAO.getEntryBySheetAndIndex(sheet, entry.getSequenceIndex());
		Assert.assertNotNull(entryEval);
		Assert.assertEquals(entry.getKey(), entryEval.getKey());
	}

	@Test
	public void testDeleteEntry() throws EntryAlreadyExistsException, SheetAlreadyExistsException {
		try {
			Sheet sheet = sheetDAO.createNewSheet(Constants.TEST_USER_ID, 12, 2013);
			Entry entry = entryDAO.createNewEntry('I', 33000, "APRIL_MONTH_SALARAY", "April Month Salary", 'S', sheet);
	...
	public void testGetAllEntries() throws EntryAlreadyExistsException, SheetAlreadyExistsException {
		...
		entryDAO.createNewEntry('I', 33000, "APRIL_MONTH_SALARAY", "April Month Salary", 'S', sheet);
		entryDAO.createNewEntry('E', 6000, "HOUSE_RENT", "House Rent", 'S', sheet);
	...
	public void testGetEntriesBySheet() throws SheetAlreadyExistsException, EntryAlreadyExistsException {
		...
		entryDAO.createNewEntry('I', 33000, "DECEMBER_MONTH_SALARAY", "December Month Salary", 'S', dec_13);
		entryDAO.createNewEntry('E', 6000, "DECEMBER_HOUSE_RENT", "December House Rent", 'S', dec_13);
		entryDAO.createNewEntry('I', 33000, "NOVEMBER_MONTH_SALARAY", "November Month Salary", 'S', nov_13);
		entryDAO.createNewEntry('E', 6000, "NOVEMBER_HOUSE_RENT", "November House Rent", 'S', nov_13);
	...
	public void testUpdateEntry() throws SheetAlreadyExistsException, EntryAlreadyExistsException, EntryNotFoundException {
		Sheet dec_13 = sheetDAO.createNewSheet(Constants.TEST_USER_ID, 12, 2013);
		Entry decSalaryEntry = entryDAO.createNewEntry('I', 33000.00, "DECEMBER_MONTH_SALARAY", "December Month Salary", 'S', dec_13);
		entryDAO.createNewEntry('E', 6000, "DECEMBER_HOUSE_RENT", "December House Rent", 'S', dec_13);
	...
	public void testAddEntryCheckUnique() throws SheetAlreadyExistsException, EntryAlreadyExistsException, EntryNotFoundException {
		Sheet dec_13 = sheetDAO.createNewSheet(Constants.TEST_USER_ID, 12, 2013);
		Entry decSalaryEntry = entryDAO.createNewEntry('I', 33000.00, "DECEMBER_MONTH_SALARAY", "December Month Salary", 'S', dec_13);
		Entry decHouseRentEntry = entryDAO.createNewEntry('E', 6000.00, "DECEMBER_HOUSE_RENT", "December House Rent", 'S', dec_13);
