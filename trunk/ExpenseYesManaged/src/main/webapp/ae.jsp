...
<body>
	...
	<form action="/ea/#content" method="POST">
		...
		<table class="form-container">
			<tr>
				<td><label class="required-field">Type *</label><br />
					<span>
			...
			<tr>
				<td><label for="shortCode" class="required-field">Label *</label><br /> <input type="text"
					id="shortCode" name="shortCode" maxlength="32" size="10" value="<c:out value='${sessionScope.INPUT_SHORT_CODE}'/>" /></td>
			</tr>
			<tr>
				<td><label for="amount" class="required-field">Amount *</label><br /> <input type="text"
					id="amount" name="amount" maxlength="32" size="10" value="<c:out value='${sessionScope.INPUT_AMOUNT}'/>" /></td>
			</tr>
			<tr>
				<td><label for="description" class="optional-field">Describe</label><br /> <textarea id="description" name="description" rows="4" cols="11"><c:out value='${sessionScope.INPUT_DESCRIPTION}'/></textarea></td>
			</tr>
			<tr>
