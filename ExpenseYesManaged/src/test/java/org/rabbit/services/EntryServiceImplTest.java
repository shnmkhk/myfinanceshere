...
public class EntryServiceImplTest extends BaseTest {
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#addANewEntry(char, double, java.lang.String, java.lang.String, char, org.rabbit.model.Sheet)}
	 * .
	 * 
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#deleteEntry(com.google.appengine.api.datastore.Key, int)}
	 * .
	 * 
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#getAllEntries()}.
	 * 
	 * @throws EntryAlreadyExistsException
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#getEntries(com.google.appengine.api.datastore.Key)}
	 * .
	 * 
	 * @throws EntryAlreadyExistsException
	 * @throws SheetNotFoundException
	...
	public final void testGetEntries() throws EntryAlreadyExistsException, SheetNotFoundException, SheetAlreadyExistsException, EntryNotFoundException {
		...
		List<Entry> nov13Entries = entryService.getEntries(KeyFactory.createKey(Sheet.class.getSimpleName(), 11 + "_" + 2013));
		List<Entry> dec13Entries = entryService.getEntries(KeyFactory.createKey(Sheet.class.getSimpleName(), 12 + "_" + 2013));
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#getEntryBySheetAndIndex(com.google.appengine.api.datastore.Key, int)}
	 * .
	 * 
	 * @throws SheetNotFoundException
	 * @throws EntryNotFoundException
	...
	/**
	 * Test method for
	 * {@link org.rabbit.services.impl.EntryServiceImpl#updateEntry(org.rabbit.model.Entry)}
	 * .
	 * 
	 * @throws SheetNotFoundException
	 * @throws EntryNotFoundException
