	...
	<c:if test="${not empty sessionScope.SHEET_MONTH_YR_ARRAY}">
		<div style="padding-bottom: 3px;">
			...
			<ul class="horizontal-list" style="text-align: left; width: 100%;">
				...
				<li>&nbsp;|&nbsp;</li>
				<li><a href="<c:url value='/ea/#content'/>" onclick="doAjax(current_page_uri);return false;">Reload entries</a></li>
				<li>&nbsp;|&nbsp;</li>
				<li><a href="<c:url value='/mae.jsp?sid=${sessionScope.SHEET_KEY_ID}#content'/>" class="submit">Add entries </a></li>
			</ul>
		</div>
	</c:if>
	<jsp:include page="../private/display.le.jsp"></jsp:include>
	<script type="text/javascript" src="../scripts/displayTagAjax.js"></script>
